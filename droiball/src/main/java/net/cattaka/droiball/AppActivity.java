...
public class AppActivity extends FragmentActivity implements IAppStub, View.OnClickListener {
    private ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            mGeppaService = IPassiveGeppaService.Stub.asInterface(service);
    ...
    private IPassiveGeppaServiceListener.Stub mGeppaServiceListener = new IPassiveGeppaServiceListener.Stub() {
        @Override
        public void onConnectionStateChanged(ConnectionState connectionState) throws RemoteException {
    ...
    private IPassiveGeppaService mGeppaService;
